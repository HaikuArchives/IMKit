 ...
 */
#ifndef _CONTACT_SPECIFICATION_H
#define _CONTACT_SPECIFICATION_H
...
namespace IM {
	...
	public:
		...
		{
			ASSERT_WITH_MESSAGE(fConnection.HasAccount(),
				"Connection does not indicate an account - this indicates incomplete multi-account support");
		}

...
public:
							SettingsFile(const char* leafname = NULL, const char* basename = NULL,
			...
			const node_ref*	NodeRef() { return &fNodeRef; }

private:
	static	status_t		_StoreAttributes(const BMessage* m, BFile* f, const char* basename = "");

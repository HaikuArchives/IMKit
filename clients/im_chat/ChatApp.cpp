	...
	fIsQuiting(false)
{
	...
	iconSize.AddString("description", "Toolbar Icon Size");
	iconSize.AddInt32("type", B_INT32_TYPE);
	iconSize.AddInt32("default", B_LARGE_ICON);
	iconSize.AddString("help", "Size of toolbar icons");
	iconSize.AddInt32("valid_value", B_MINI_ICON);
	iconSize.AddInt32("valid_value", B_LARGE_ICON);
